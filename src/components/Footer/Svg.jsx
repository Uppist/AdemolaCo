...
export default function Svg() {
  return (
    <div className={styles.svg}>
      {/*Fackbook svg */}
      <Link to='https://web.facebook.com/RootheKharisPartners '>
        <svg
          width='40'
          height='40'
          viewBox='0 0 40 40'
      ...
      >
        ...
        <path
          ...
          fill='white'
        />
        <path d='M11 10H16V12H11V10ZM24 30H29V28H24V30Z' fill='white' />
        <path d='M26.5 10H30L13 30H9.5L26.5 10Z' fill='white' />
      </svg>

      {/*Instagram svg */}
      <Link
        to='https://www.instagram.com/roothekharis/
 '
      >
        <svg
          width='40'
      ...
      {/*LinkedIn Svg */}
      <Link
        to='https://www.linkedin.com/company/roothe-kharis-partners/posts/?feedView=all
'
      >
        <svg
          width='40'
